    ...
    <div className="relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center ">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <Button
            type="submit"
            className="bg-blue-600 dark:bg-blue-700 text-white px-6 py-3 rounded-r-full hover:bg-gray-700 dark:hover:bg-blue-800"
          >
            Search
          </Button>
        </form>
        <Button
          ...
          className="bg-white dark:bggray-800 text-blue-600 rounded-full hover:bg-gray-200 "
        >
          Explore Courses
        </Button>
      </div>
